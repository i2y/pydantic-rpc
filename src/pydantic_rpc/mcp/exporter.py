...
try:
    ...
    raise ImportError(
        "mcp is required for MCP support. "
...
class MCPExporter:
    ...
    def __init__(self, service_obj: object, name: Optional[str] = None, description: Optional[str] = None):
        ...
        self.description = description or f"MCP tools from {service_obj.__class__.__name__}"
    ...
    def _register_handlers(self):
        ...
        async def handle_call_tool(name: str, arguments: dict[str, Any] | None) -> list[Content]:
            """Execute a tool."""
            ...
            if params and params[0].annotation != inspect._empty:
                ...
                if inspect.isclass(param_type) and issubclass(param_type, BaseModel):
                    ...
                    if inspect.iscoroutinefunction(method):
                        ...
                        self.tools[tool_name] = (tool, make_async_wrapper(method, param_type))
                    else:
                        ...
                        self.tools[tool_name] = (tool, make_sync_wrapper(method, param_type))
                else:
