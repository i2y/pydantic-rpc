...
def main():
    ...
    if not DEBUG:
        ...
        print("This server can be used with any MCP-compatible client.", file=sys.stderr)
        print("For example, to use with Claude Desktop, add to claude_desktop_config.json:", file=sys.stderr)
